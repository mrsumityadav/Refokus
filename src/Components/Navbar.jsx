...
function Navbar() {
  return (
    <div className="w-full px-10 fixed py-4 z-50 flex items-center justify-between">
      <button className="px-4 hover:bg-white hover:text-[#0F1215] py-2 border uppercase text-xs font-semibold rounded-full border-white">
        Menu
      </button>
      <svg
        width="1.3vw"
      ...
      <a
        href="#"
        className="hover:bg-white hover:text-[#0F1215] px-4 py-2 border uppercase text-xs font-semibold rounded-full border-whites"
      >
        CONTACT
      </a>
    </div>
